      ...
      <div className="max-w-7xl mx-auto px-4 pt-8 pb-6">
        ...
        <div className="grid grid-cols-3 md:grid-cols-4 gap-4 md:gap-6">
          ...
          <div className="col-span-4 md:col-span-1">
            ...
            <a href={siteConfig.social.facebook} target="_blank" aria-label="Facebook পেজ"
              ...
              <a href={siteConfig.social.youtube} target="_blank" aria-label="YouTube চ্যানেল"
              ...
              <a href={`tel:${siteConfig.contact.phone}`} aria-label="ফোন করুন"
              ...
              <a href={`https://wa.me/${siteConfig.contact.whatsapp}`} target="_blank" aria-label="WhatsApp এ মেসেজ করুন"
              ...
              <a href={siteConfig.social.instagram} target="_blank"  aria-label="Instagram পেজ"
              ...
              <a href={siteConfig.social.tiktok} target="_blank" aria-label=" tiktok পেজ "
          ...
          <h4 className="font-bold mb-3 text-sm text-green-900">{t.farmHeading}</h4>
            <div className="flex flex-col gap-1.5 text-sm text-black">
              ...
              <a href={`https://wa.me/${siteConfig.contact.whatsapp}`} target="_blank" className="hover:text-green-700 transition">💬 {siteConfig.contact.phoneDisplay}</a>
