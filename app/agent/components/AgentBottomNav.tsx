...
export default function AgentBottomNav() {
  ...
  return (
    ...
    >
      <Link href="/agent/orders" className={`flex flex-col items-center text-xs gap-1 px-2 py-1 ${isActive("/agent/orders") && !isActive("/agent/orders/create") ? "text-yellow-400" : "text-white"}`}>
