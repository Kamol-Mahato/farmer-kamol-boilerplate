export default function ContactPage() {
    ...
    return (
      <main className="pt-12 sm:pt-10 pb-6 bg-white">
        <div className="max-w-2xl mx-auto px-2 flex flex-col items-center text-center">
          <h1 className="text-2xl sm:text-3xl font-extrabold text-green-900 mb-8">
          ...
          <div className="flex gap-4 sm:gap-5 mt-10 flex-wrap justify-center">
            <a
              href="https://facebook.com/farmerkamol"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Facebook"
              className="w-14 h-14 rounded-full bg-blue-600 flex items-center justify-center shadow-md hover:scale-110 transition-transform"
            >
            ...
            <a
              ...
              rel="noopener noreferrer"
              aria-label="YouTube"
              className="w-14 h-14 rounded-full bg-red-600 flex items-center justify-center shadow-md hover:scale-110 transition-transform"
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-7 h-7" fill="white">
            ...
            <a
              ...
              aria-label="ফোন করুন"
              className="w-14 h-14 rounded-full bg-gray-800 flex items-center justify-center shadow-md hover:scale-110 transition-transform"
            >
              <svg
            ...
            <a
              ...
              rel="noopener noreferrer"
              aria-label="WhatsApp"
              className="w-14 h-14 rounded-full bg-green-500 flex items-center justify-center shadow-md hover:scale-110 transition-transform"
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-7 h-7" fill="white">
            ...
            <a
              href="https://www.instagram.com/farmer.kamol"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Instagram"
              className="w-14 h-14 rounded-full bg-gradient-to-tr from-purple-600 via-pink-500 to-yellow-400 flex items-center justify-center shadow-md hover:scale-110 transition-transform"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
            ...
            <a
              href="https://www.tiktok.com/@farmer.kamol"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="TikTok"
              className="w-14 h-14 rounded-full bg-black flex items-center justify-center shadow-md hover:scale-110 transition-transform"
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-7 h-7" fill="white">
